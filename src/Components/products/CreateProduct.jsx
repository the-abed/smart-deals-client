            ...
            <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center p-4 transition-colors duration-300">
                ...
                <form onSubmit={handleCreateProduct} className="mt-4 space-y-4">
                    <div className="flex flex-col">
                        <label htmlFor="title" className="text-gray-600 dark:text-gray-300">
                            Title
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="description" className="text-gray-600 dark:text-gray-300">
                            Description
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="image_url" className="text-gray-600 dark:text-gray-300">
                            Image URL
                        </label>
                        </div>
                        <input
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="price_min" className="text-gray-600 dark:text-gray-300">
                                Min Price
                            </label>
                            <input
                                type="number"
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="price_max" className="text-gray-600 dark:text-gray-300">
                                Max Price
                            </label>
                            <input
                                type="number"
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="condition" className="text-gray-600 dark:text-gray-300">
                                Condition
                            </label>
                            <input
                                type="text"
